...
namespace WxTeamsSharp.Interfaces.Teams
{
    ...
    public interface ITeam : IListable
    {
        ...
        Task<IListResult<TeamMembership>> GetMembershipsAsync(int max = 100);
        ...
        Task<IMembership<TeamMembership>> AddUserAsync(string userIdOrEmail, bool isModerator = false);
        ...
        Task<IMembership<TeamMembership>> UpdateUserAsync(string userIdOrEmail, bool isModerator);
